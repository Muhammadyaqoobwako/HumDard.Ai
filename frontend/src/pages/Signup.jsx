...
function Signup() {
  ...
  return (
    <main className="min-h-[calc(100vh-78px)] bg-gradient-to-br from-slate-50 via-white to-blue-50 px-4 py-6 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 sm:px-6 lg:px-8">
      <section className="mx-auto grid w-full max-w-6xl overflow-hidden rounded-3xl border border-slate-200 bg-white/80 shadow-xl backdrop-blur dark:border-slate-700 dark:bg-slate-800/70 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="hidden flex-col justify-between bg-gradient-to-br from-blue-700 to-cyan-600 p-10 text-white lg:flex">
          <div>
        ...
        <div className="w-full p-6 sm:p-8 lg:p-10">
          <div className="mx-auto w-full max-w-sm space-y-6">
            ...
            <p className="text-center text-xs leading-5 text-slate-500 dark:text-slate-400">
              Your onboarding details help HamDard AI provide more relevant
