...
const sampleQuestions = [
  {
    ...
    answer:
      "Walaikum assalam. Welcome to HamDard AI. How can I support you today?",
    video: welcomeVideo,
    keywords: [
      "hello",
      "hi",
...
function LiveSession() {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: "HamDard Ai",
      text: `Welcome to HamDard Live Session, ${user?.name || "User"}. I am ready to help.`,
    },
  ]);
  ...
  return (
    <main className="min-h-[calc(100vh-78px)] bg-slate-100 px-3 py-4 dark:bg-[#0f0f0f] sm:px-6 lg:px-8">
      <div className="mx-auto grid w-full max-w-7xl gap-4 lg:grid-cols-[1.6fr_0.95fr]">
        <section className="space-y-4">
          <article className="overflow-hidden border-4 border-blue-600 bg-gradient-to-b from-slate-900 to-slate-950 shadow-2xl shadow-blue-500/40 dark:border-blue-400">
            {/* FACE-TO-FACE VIDEO Label */}
            <div className="border-b-4 border-blue-600 bg-blue-600 px-4 py-2 text-xs font-bold uppercase tracking-widest text-white dark:bg-blue-500">
              ▮ FACE-TO-FACE VIDEO
            </div>
          ...
          <article className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-[#181818]">
            <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
                  Use your microphone to ask a question and receive a spoken
                  response.
                </p>
              </div>
            ...
            <div className="mt-4 rounded-3xl border border-slate-200 bg-slate-50 p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="mt-3 rounded-3xl bg-white px-4 py-3 shadow-sm dark:bg-[#111827]">
                <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">
                  {isListening
                    ? liveTranscript || "Listening for your question..."
                    : "Start session to speak with HamDard AI."}
                </p>
        ...
        <section className="flex min-h-[620px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-[#181818]">
          ...
          <div className="flex-1 overflow-y-auto bg-slate-50 dark:bg-[#111111]">
            <ChatBox
